...
public class IngredientManager {
    ...
    public static void setDessertList() {
        ArrayList<Desserts> temp = new ArrayList<>();
        temp.add(new Desserts("Brownie", 1.50));
        temp.add(new Desserts("Cookie", 1.00));
        temp.add(new Desserts("Pie", 2.50));
        IngredientManager.dessertList = temp;
    }
